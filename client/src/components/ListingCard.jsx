...
const ListingCard = ({ listing }) => {
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
      ...
      {/*Stats*/}
      <div className="flex flex-wrap ml-5 justify-between max-w-lg items-center gap-3 my-5">
        ...
        </div>
        {
          listing.engagement_rate && (
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span className="text-lg font-medium text-slate-800 mr-1.5">{listing.engagement_rate
              }</span>% engagement
            </div>
          )
        }
