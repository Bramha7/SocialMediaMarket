  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StartCard title={'Total Listings'} value={userListings.length} icon={<Eye className="w-6 h-6 text-indigo-600" />} color="indigo" />
        <StartCard title={'Active Listings'} value={activeListings} icon={<CheckCircle className="w-6 h-6 text-green-600" />} color="green" />
        <StartCard title={'Sold'} value={soldListings} icon={<TrendingUp className="w-6 h-6 text-indigo-600" />} color="indigo" />
        <StartCard title={'Total Value'} value={`${currency}${totalValue.toLocaleString()}`} icon={<DollarSign className="w-6 h-6 text-yellow-600" />} color="yellow" />
      </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button onClick={() => toggleStatus(listing.id)} className=" p-2 border border-gray-300 rounded-lg hover:bg-gray-50 hover:text-indigo-600">
      ...
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          @ 2025 <span className="text-indigo-600">Prashanna</span>.All right reserved
        </p>
      </div>
    </div>
  );
