  ...
  return (
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="relative max-w-xl mb-8">
        ...
        <input type="text" className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-indigo-500" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search conversations" />
      ...
      {/*chat list*/}
      {
        loading ? (
          ...
          <div className="bg-white rounded-lg shadow-xs border border-gray-200 px-16 text-center">
                  ...
                  <button onClick={() => handleOpenChat(chat)} key={chat.id} className="w-full p-4 hover:bg-gray-50 transition-colors text-left">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p
                          className={`text-sm truncate ${!chat.isLastMessageRead && chat.lastMessageSenderId !== user?.id
