    ...
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start max-md:flex-col gap-10">
        <div className="flex-1 max-md:w-full">
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            <div className="p-4 border-b border-gray-100">
              <h4 className="font-semibold text-gray-700">Account Metrics</h4>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 text-center">
              ...
              <div>
                <CalendarIcon className="mx-auto text-gray-400 w-5 h-5 mb-1" />
                <p className="font-semibold text-gray-800">
        ...
        <div className="bg-white min-w-full md:min-w-[370px] rounded-xl border border-gray-200 p-5 max-md:mb-10">
          ...
          <button onClick={loadChat} className="w-full bg-indigo-600 text-white py-2 rounded-lg hover:bg-indigo-700 transition text-sm font-medium flex items-center justify-center gap-2">
